...
![image-20200706174708418](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/7_本地方法栈/images/image-20200706174708418.png)
...
![image-20200706164139252](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/6_本地方法接口/images/image-20200706164139252.png)
...
![image-20200706195127740](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706195127740.png)
...
![image-20200706200739392](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706200739392.png)
...
![image-20200706201904057](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706201904057.png)
...
![image-20200706203419496](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706203419496.png)

堆空间内部结构，JDK1.8之前从永久代  替换成 元空间

![image-20200706203835403](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706203835403.png)
...
![image-20200706205756045](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706205756045.png)

```
-XX:+PrintGCDetails
```

![image-20200706205821919](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706205821919.png)

### OutOfMemory举例

![image-20200706205947535](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706205947535.png)

![image-20200706210000461](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706210000461.png)
...
![image-20200706211652779](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200706211652779.png)
...
![image-20200707075847954](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707075847954.png)

下面这参数开发中一般不会调：

![image-20200707080154039](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707080154039.png)
...
![image-20200707084208115](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707084208115.png)
...
![image-20200707084714886](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707084714886.png)
...
![image-20200707085232646](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707085232646.png)

我们继续不断的进行对象生成 和 垃圾回收，当Survivor中的对象的年龄达到15的时候，将会触发一次 Promotion晋升的操作，也就是将年轻代中的对象  晋升到 老年代中

![image-20200707085737207](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707085737207.png)
...
![image-20200707091058346](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707091058346.png)
...
![垃圾回收](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/垃圾回收.gif)
...
![image-20200707095606813](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707095606813.png)
...
![image-20200707101511025](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707101511025.png)

其实不分代完全可以，分代的唯一理由就是优化GC性能。如果没有分代，那所有的对象都在一块，就如同把一个学校的人都关在一个教室。GC的时候要找到哪些对象没用，这样就会对堆的所有区域进行扫描。而很多对象都是朝生夕死的，如果分代的话，把新创建的对象放到某一地方，当GC的时候先把这块存储“朝生夕死”对象的区域进行回收，这样就会腾出很大的空间出来。

![image-20200707101543871](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707101543871.png)
...
![image-20200707103547712](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707103547712.png)
...
![image-20200707104253530](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707104253530.png)
...
![image-20200707203038615](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707203038615.png)
...
![image-20200707203441718](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707203441718.png)
...
![image-20200707205634266](C:/WorkSpace/IdeaProjects/LearningNotes/JVM/1_内存与垃圾回收篇/8_堆/images/image-20200707205634266.png)
