...
<img src="https://img-blog.csdnimg.cn/20201005215251133.png" style="zoom: 50%;" />
...
<img src="https://img-blog.csdnimg.cn/20201005215353995.png" style="zoom: 67%;" />
...
- class file☞存在于本地硬盘上，可以理解为一个模板，而这个模板在执行的时候是需要加载到JVM当中，而JVM再根据这个模板实例化出n个一模一样的实例。
...
<img src="https://img-blog.csdnimg.cn/20201005220756234.png" style="zoom:80%;" />

完整的流程图如下所示：

<img src="https://img-blog.csdnimg.cn/20201005222258779.png" style="zoom: 50%;" />
...
我们可以通过安装IDEA的插件，来查看我们的Class文件：

![](https://img-blog.csdnimg.cn/20201005225203995.png)

安装完成后，我们编译完一个class文件后，点击view即可显示我们安装的插件来查看字节码方法：

![](https://img-blog.csdnimg.cn/20201005225320945.png)
...
![image-20200705094149223](C:/Users/kaiz1/Desktop/LearningNotes/JVM/1_内存与垃圾回收篇/2_类加载子系统/images/image-20200705094149223.png)
...
![image-20200705103516138](C:/Users/kaiz1/Desktop/LearningNotes/JVM/1_内存与垃圾回收篇/2_类加载子系统/images/image-20200705103516138.png)

sun.misc.Launcher 它是一个java虚拟机的入口应用

![image-20200705103636003](C:/Users/kaiz1/Desktop/LearningNotes/JVM/1_内存与垃圾回收篇/2_类加载子系统/images/image-20200705103636003.png)
...
![image-20200705105151258](C:/Users/kaiz1/Desktop/LearningNotes/JVM/1_内存与垃圾回收篇/2_类加载子系统/images/image-20200705105151258.png)
...
![image-20200705105810107](C:/Users/kaiz1/Desktop/LearningNotes/JVM/1_内存与垃圾回收篇/2_类加载子系统/images/image-20200705105810107.png)
