...
- [1.概览](#1概览)
- [2.自定义枚举方法](#2自定义枚举方法)
- [3.使用 == 比较枚举类型](#3使用--比较枚举类型)
- [4.在 switch 语句中使用枚举类型](#4在-switch-语句中使用枚举类型)
- [5.枚举类型的属性，方法和构造函数](#5枚举类型的属性方法和构造函数)
- [6.EnumSet and EnumMap](#6enumset-and-enummap)
  - [6.1. EnumSet](#61-enumset)
  - [6.2. EnumMap](#62-enummap)
- [7. 通过枚举实现一些设计模式](#7-通过枚举实现一些设计模式)
  - [7.1 单例模式](#71-单例模式)
  - [7.2 策略模式](#72-策略模式)
- [8. Java 8 与枚举](#8-java-8-与枚举)
- [9. Enum 类型的 JSON 表现形式](#9-enum-类型的-json-表现形式)
- [10.总结](#10总结)
- [11. 补充](#11-补充)
