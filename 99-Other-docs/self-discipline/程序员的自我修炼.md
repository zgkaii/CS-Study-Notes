...
- [ ] 前端
  ...
  - [x] 基础
    ...
    - [x] [HTML 文档](https://developer.mozilla.org/zh-CN/docs/Web/HTML) 
    - [x] [CSS 文档](https://developer.mozilla.org/zh-CN/docs/Web/CSS) 
...
4. 坚持用英文词典而不是中文的。比如：[剑桥英语词典](https://dictionary.cambridge.org/) 或是 [Dictionary.com](http://www.dictionary.com/) ，可以安装一个 Chrome 插件 [Google Dictionary](https://chrome.google.com/webstore/detail/google-dictionary-by-goog/mgijmajocgfcbeboacabfgobmjgjcoja)。
...
- [ ] [X-Y Problem](http://xyproblem.info/) /《[X-Y 问题](https://coolshell.cn/articles/10804.html)》
