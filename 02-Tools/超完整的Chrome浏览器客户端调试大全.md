...
[![img](https://img-blog.csdnimg.cn/img_convert/5f41081e773efe04ec77034b4b2fb24b.png)](http://igeekbar.com/igeekbar/networks/uploadimg/52af2165-aa3b-41ea-acdf-4c3fb7ba3b27.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/a5610c0112403e3f0974257c7b2ff9ac.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/9f216c246aab1b2412bcf7d2c177c211.png)]

- 对应的样式
![img](https://img-blog.csdnimg.cn/img_convert/e8b963cf90ab916847d16abb37131ae6.png)
- 盒模型信息
...
![img](https://img-blog.csdnimg.cn/img_convert/4efb757057f79ec193f155b0761c7e6f.png)

其他功能

b: 除了console.log还有其他相关的指令可用

![img](https://img-blog.csdnimg.cn/img_convert/c9e89ff57e45cc90d97abaa4234820c3.png)
console也有相关的API
...
![img](https://img-blog.csdnimg.cn/img_convert/e1f89c0b6abef273cc31a4a7d97d0cd1.png)
- 对应的源代码
![img](https://img-blog.csdnimg.cn/img_convert/9fda200760847ce50d87dd77f9ebe544.png)
- 格式化后的代码
...
![img](https://img-blog.csdnimg.cn/img_convert/96d0801e2cfdfda96afb05356c0a0445.png)
- 自己书写的片段
...
![img](https://img-blog.csdnimg.cn/img_convert/cadfb963c62e99f277fab8bd08d9a77e.png)
无结果
...
![img](https://img-blog.csdnimg.cn/img_convert/e0a81e2715b8a011c8ae1e47f211cf79.png)

- 所有的资源

以上我选择了All，就会把该页面所有资源文件请求下来，如果只选择XHR 异步请求资源，则我们可以分析相关的请求信息
![img](https://img-blog.csdnimg.cn/img_convert/282e5e6a25f2573d929f4e1d686c12a2.png)

- 请求的相关信息

打开一个Ajax异步请求，可以看到它的请求头信息，是一个POST请求，参数有哪些，还可以预览它的返回的结果数据，这些数据的使用和查看有利于我们很好的和后端工程师们联调数据，也方便我们前端更直观的分析数据
![img](https://img-blog.csdnimg.cn/img_convert/f6e2a03b9de3ec44d3299f22513da064.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/1bc9cceeb83d4e6be3441e076137ccb0.png)
- 分析结果
## 二.Sources资源页面的断点调试
**1.如何调试**：

调试js代码，肯定是我们常用的功能，那么如何打断点，找到要调试的文件，然后在内容源代码左侧的代码标记行处点击即可打上一个断点
![img](https://img-blog.csdnimg.cn/img_convert/75759b5b8a8ba4b30cad91ec2c524ba3.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/43c3fa4f4ccea3237336e28aa3e612e2.png)
- 在代码中打断点

在当前的代码执行区域，在调试中如果发现需要修改的地方，也是可以立即修改的，修改后保存即可生效，这样就免去了再到代码中去书写，再刷新回看了
![img](https://img-blog.csdnimg.cn/img_convert/a712c98d5640cd84f7f4eec6d5b21ab1.png)
临时修改
...
[![img](https://img-blog.csdnimg.cn/img_convert/d3f4dd0e46dd519cee9e2f181bab5a5e.png)

**4.调试的功能区域**

每一个功能区，都有它相关的左右，先来看一张图，它都有哪些功能

![img](https://img-blog.csdnimg.cn/img_convert/86565b14e025dfade12c44e36421b857.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/905fd9c77935f9248fdd462b0ac6ec96.png)

但是若你想从新从某个调用方法出执行，可以右键Restart Frame， 断点就会跳到此处开头重新执行，**Scope** 中的变量值也会依据代码从新更改，这样就可以回退来从新调试，错过的调试也可以回过头来反复查看

![img](https://img-blog.csdnimg.cn/img_convert/10366fd073011215f3f7395672a2e517.png)
**Breakpoints**关于断点：所有当前js的断点都会展示在这个区域，你可以点击按钮用来“去掉/加上”此处断点，也可以点击下方的代码表达式，调到相应的程序代码处，来查看

![img](https://img-blog.csdnimg.cn/img_convert/88721dce89fef491984ca117d45eb759.png)
**XHR Breakpoints**

在XHR Breakpoints处，点击右侧的+号，可以添加请求的URL，一旦 XHR 调用触发时就会在 request.send() 的地方中断
![img](https://img-blog.csdnimg.cn/img_convert/27f9975a2efcc5e7a490325d7d865af7.png)
**DOM Breakpoints:**

可以给你的DOM元素设置断点，有时候真的需要监听和查看某个元素的变化情况，赋值情况，但是我们并是不太关心哪一段代码对它做的修改，只想看看它的变化情况，那么可以给它来个监听事件，这个时候DOM Breakpoints中会如图

![img](https://img-blog.csdnimg.cn/img_convert/b38d7d69739aca8ddab1a2c7c27aec5f.png)
...
![img](https://img-blog.csdnimg.cn/img_convert/ac6a39a593b2bf328514f46124256d80.png)

该扩展程序使用非常简单，功能同时也非常强大，输入你的请求，选择好请求的method，需要请求参数的挨个填好，send之后，就可以看到返回的数据，这个小工具很利于我们的开发

![img](https://img-blog.csdnimg.cn/img_convert/e474befa1d7182b23526aa50a9769b6c.png)
## 完结
