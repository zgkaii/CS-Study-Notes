- [一、System.gc()的理解](#一systemgc的理解)
- [二、内存溢出与内存泄漏](#二内存溢出与内存泄漏)
  - [2.1 内存溢出](#21-内存溢出)
  - [2.3 内存泄漏](#23-内存泄漏)
- [三、Stop The World](#三stop-the-world)
- [四、垃圾回收的并行与并发](#四垃圾回收的并行与并发)
  - [4.1 并行与并发](#41-并行与并发)
...
**也称作“存储渗漏”（Memory Leak）**。严格来说，**只有对象不会再被程序用到了，但是GC又不能回收他们的情况，才叫内存泄漏**。
...
> 买房子：80平的房子，但是有10平是公摊的面积，我们是无法使用这10平的空间，这就是所谓的内存泄漏。
 ...
 <div align="center"> <img src="..\..\images\jvm\内存泄漏.png" width="600px"></div>
...
* **并行**：指两个或多个任务在**同一时刻**发生（同时发生）。
 ...
 <div align="center"> <img src="..\..\images\jvm\20200928145847985.png" width="600px"></div>
...
这4种引用**强度依次逐渐减弱**。除强引用外，其他3种引用均可以在`java.lang.ref`包中找到它们的身影。
 ...
 <div align="center"> <img src="..\..\images\jvm\reference.png" width="700px"></div>
...
对应的内存结构为：
 ...
 <div align="center"> <img src="..\..\images\jvm\20201015002111566.png" width="500px"></div>
