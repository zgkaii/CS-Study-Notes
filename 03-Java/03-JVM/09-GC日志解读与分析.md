- [一、Serial GC日志解读](#一serial-gc日志解读)
- [二、Parallel GC 日志解读](#二parallel-gc-日志解读)
- [三、CMS的GC日志解读](#三cms的gc日志解读)
- [三、G1的GC日志解读](#三g1的gc日志解读)
  - [Evacuation Pause: young(纯年轻代模式转移暂停)](#evacuation-pause-young纯年轻代模式转移暂停)
  - [Concurrent Marking(并发标记)](#concurrent-marking并发标记)
  - [Evacuation Pause (mixed)(转移暂停: 混合模式)](#evacuation-pause-mixed转移暂停-混合模式)
  - [Full GC (Allocation Failure)](#full-gc-allocation-failure)
  **常用启动参数**
