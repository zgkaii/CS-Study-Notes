...
- [ ] CAS原理
- [ ] syncronize原理，以及锁升级
- [ ] JUC常用并发工具类，可重入锁原理，CountdownLatch、循环栅栏、信号量、LockSupport
- [ ] 原子类源码（AtomicInteger)
- [ ] ThreadLocal源码
- [ ] 线程安全容器，阻塞队列如何实现，ConcurrentHashMap原理、CopyOnwriteArrayList原理
- [ ] currenthashmap如何实现线程安全？加锁力度是多大？jdk1.8使用cas及synchronized保证线程安全
- [ ] ConcurrentHashMap 和 Hashtable 的区别
- [ ] 线程池参数有哪些。讲述一下参数作用及原理？项目中业务中使用线程池的场景？线程池配置参数选择依据？
- [ ] 线程池拒绝策略有哪几种，分别是什么。
- [ ] volitle 作用即实现原理，是如何保证从主存中取到最新值的（MESI、CPU高速缓存，建议背诵，好几家公司问到了，贼特么恶心）
- [ ] 线程池如何回收不用的线程
- [ ] 线程间通信机制（手写生产者消费者）
- [ ] sleep() 方法和 wait()异同
- [ ] synchronized 和 ReentrantLock 的区别？
- [ ] reentrantlock的实现原理？renntrantlock如何实现公平锁和非公平锁？
